...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Insta, InstaViewHolder> FBRA = new FirebaseRecyclerAdapter<Insta, InstaViewHolder>(Insta.class, R.layout.insta_item, InstaViewHolder.class, mDatabase) {
            @Override
            protected void populateViewHolder(InstaViewHolder viewHolder, Insta instaItem, int position) {
                final String postKey = getRef(position).getKey().toString();
                viewHolder.setTitle(instaItem.getTitle());
                viewHolder.setDesc(instaItem.getDesc());
                viewHolder.setImage(getApplicationContext(), instaItem.getImage());
                viewHolder.setUsername(instaItem.getUsername());
